...
data = dict(
    ...
    train=dict(type=dataset_type, ann_file=ann_file_train, split='xsub_train', data_prefix=data_root, pipeline=train_pipeline),
    val=dict(type=dataset_type, ann_file=ann_file_val, split='xsub_val', data_prefix=data_root, pipeline=val_pipeline),
    test=dict(type=dataset_type, ann_file=ann_file_val, split='xsub_val', data_prefix=data_root, pipeline=test_pipeline))
# optimizer
...
work_dir = './work_dirs/rgbpose_conv3d/face_pose_conv3d'
load_from = '/home/chenyanting/pyskl/my_mod/weights/facepose_conv3d_init.pth'
